...
parser.add_argument("-db", "--database", help="Database name: CVC-ClinicDB or CVC-ColonDB")
...
for entry in entries:
    ...
    ET.SubElement(source, "database").text = args.database
    ...
    output = os.path.join(annotations_output, (entry.split(".")[0] + ".xml"))
    tree.write(output)
